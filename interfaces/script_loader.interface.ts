...
enum  EventStrings{
    ...
    VERIFY_MESSAGE_CLOUD = "VERIFY_MESSAGE_CLOUD",

    AUTOMATIC_OBD_OAUTH_CLOUD = "AUTOMATIC_OBD_OAUTH_CLOUD",
    AUTOMATIC_OBD_OAUTH_LOCAL = "AUTOMATIC_OBD_OAUTH_LOCAL",
    AUTOMATIC_OBD_EVENTS_CLOUD = "AUTOMATIC_OBD_EVENTS_CLOUD",
    AUTOMATIC_OBD_EVENTS_LOCAL = "AUTOMATIC_OBD_EVENTS_LOCAL",
